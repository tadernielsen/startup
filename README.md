...
- [x] **Stores data in MongoDB** - Stores application devLogs, games, and announcement into the database.
- [x] **Stores credentials in MongoDB** - Stores users, their passwords, and their userType into the database.
